...
const defaultFieldBackground = computed(() => defaultFieldBackgrounds[props.resolvedTheme])
...
const themePreferenceModel = computed({
...
.brand-block { display: grid; gap: 10px; justify-items: start; }
.nav-link {
  display: inline-flex;
  align-items: center;
  min-height: 42px;
